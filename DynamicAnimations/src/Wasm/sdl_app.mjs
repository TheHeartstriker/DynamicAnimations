...
var ASM_CONSTS = {
 ...
 142266: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 142349: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 142418: () => { return window.innerWidth; },  
 142448: () => { return window.innerHeight; }
};
